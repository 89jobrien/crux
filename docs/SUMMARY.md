...
- [Combinators](pipelines/03-combinators.md)
...
- [Branching and delegation](walkthrough/03-branching-delegation.md)
- [Task registry](walkthrough/04-task-registry.md)
- [Lifecycle hooks](walkthrough/05-lifecycle-hooks.md)
