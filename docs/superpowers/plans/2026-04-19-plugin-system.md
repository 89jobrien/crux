...
toml = "0.8"
cruxai-core = { path = "../crux-core", version = "0.2.4" }
cruxai-script = { path = "../crux-script", version = "0.2.4" }
...
Run: `./target/debug/crux run examples/extract_entities.yaml`
...
5. `./target/debug/crux run examples/extract_entities.yaml` --
