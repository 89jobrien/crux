//! Deterministic, rule-based goal-to-steps planning.
//!
...
//!
//! Canonical definition shared by `crux-planner::rule_planner` and
//! `crux-agentic::bin::crux`.
...
///
/// ```
/// use crux_types::planner::{PlanRule, RulePlanner};
///
/// let rules = vec![
