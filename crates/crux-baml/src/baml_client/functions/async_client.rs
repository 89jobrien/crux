...
baml_function_async!(AssessHealth(name: impl AsRef<str> + BamlEncode, pushed_at: impl AsRef<str> + BamlEncode, commit_dates: &[String], open_issues: Option<i64>, ) -> (stream_types::AssessHealthOutput, types::AssessHealthOutput));

baml_function_async!(Classify(text: impl AsRef<str> + BamlEncode, labels: &[String], ) -> (stream_types::ClassifyOutput, types::ClassifyOutput));

baml_function_async!(ClassifyCIFailure(failure_output: impl AsRef<str> + BamlEncode, known_patterns: &[String], ) -> (stream_types::ClassifyCIFailureOutput, types::ClassifyCIFailureOutput));

baml_function_async!(ClassifyProject(name: impl AsRef<str> + BamlEncode, description: Option<impl AsRef<str> + BamlEncode>, language: Option<impl AsRef<str> + BamlEncode>, topics: &[String], commits: &[String], ) -> (stream_types::ClassifyProjectOutput, types::ClassifyProjectOutput));

baml_function_async!(DecomposeSpec(text: impl AsRef<str> + BamlEncode, ) -> (stream_types::DecomposeSpecOutput, types::DecomposeSpecOutput));

baml_function_async!(DescribeProject(name: impl AsRef<str> + BamlEncode, language: Option<impl AsRef<str> + BamlEncode>, readme: Option<impl AsRef<str> + BamlEncode>, commits: &[String], ) -> (stream_types::DescribeProjectOutput, types::DescribeProjectOutput));

baml_function_async!(ExtractEntities(text: impl AsRef<str> + BamlEncode, ) -> (stream_types::ExtractEntitiesOutput, types::ExtractEntitiesOutput));

baml_function_async!(GenerateChangelog(name: impl AsRef<str> + BamlEncode, commits: &[String], ) -> (stream_types::GenerateChangelogOutput, types::GenerateChangelogOutput));

baml_function_async!(GeneratePipeline(goal: impl AsRef<str> + BamlEncode, available_handlers: &[String], constraints: Option<impl AsRef<str> + BamlEncode>, ) -> (stream_types::PipelineDef, types::PipelineDef));

baml_function_async!(SuggestRelated(name: impl AsRef<str> + BamlEncode, description: Option<impl AsRef<str> + BamlEncode>, category: Option<impl AsRef<str> + BamlEncode>, all_projects: &[String], ) -> (stream_types::SuggestRelatedOutput, types::SuggestRelatedOutput));

baml_function_async!(Summarize(text: impl AsRef<str> + BamlEncode, max_sentences: i64, ) -> (stream_types::SummarizeOutput, types::SummarizeOutput));
